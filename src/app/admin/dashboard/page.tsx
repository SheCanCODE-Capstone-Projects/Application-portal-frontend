...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-8 max-w-[1800px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 shadow-sm rounded-full border border-gray-100/50">
        <GraphicalCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Status distribution across active cohorts
            </CardDescription>
          </CardHeader>
          <CardContent className="h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={stats?.charts?.cohortBreakdown || []}
                barSize={40}
              >
                <CartesianGrid
                  strokeDasharray="3 3"
        ...
        <CardHeader className="bg-gray-50/50 border-b border-gray-100 pb-4">
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Manage and review applicant details.
              </CardDescription>
            </div>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Select value={selectedYear} onValueChange={setSelectedYear}>
                <SelectTrigger className="w-[160px]">
                  <SelectValue placeholder="Year Applied" />
                </SelectTrigger>
                <SelectContent>
                  ...
                  {[
                    ...new Set(
                      applications.map((app) =>
                        new Date(app.createdAt).getFullYear().toString(),
                      ),
                    ),
                  ].map((year) => (
...
function GraphicalCard({
  ...
  return (
    <div
      className={`relative p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all overflow-hidden bg-white`}
    >
      {/* Header */}
      <div className="flex justify-between items-start z-10 relative">
        <div>
          ...
          <div className="flex items-baseline gap-2 mt-1">
            ...
            {trend && (
              <span
                className={`flex items-center text-xs font-bold px-1.5 py-0.5 rounded ${isUp ? "text-emerald-700 bg-emerald-50" : isDown ? "text-rose-700 bg-rose-50" : "text-gray-600 bg-gray-100"}`}
              >
                {isUp ? (
